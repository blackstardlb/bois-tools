...
internal class CharacterCensusRepositoryTest {
    ...
    @Test
    fun getCharacterStatHistories() {
        val blackStarDLBStats = characterCensusRepository.getCharacterStatHistories("5428072203476045489").block().shouldNotBeNull()
    ...
    fun getCharactersById() {
        val characters = characterCensusRepository.getCharactersByIds(listOf("5428072203476045489")).block().`should not be null`()
